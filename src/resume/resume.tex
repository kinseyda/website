...
\parbox[t]{0.75\textwidth}{
	{\centering
			\textbf{Software developer} and \textbf{summa cum laude computer science graduate} in
...
\begin{itemize}
	\item \textbf{Graduated with highest distinction}/ \textbf{Summa Cum Laude}
...
\begin{itemize}
	\item \textbf{Languages}: C, C++, C\#, Java, Javascript, Python, SQL,
	      Typescript
